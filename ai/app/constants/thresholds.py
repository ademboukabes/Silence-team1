...
# Note: carrier_scoring.py has been removed, but thresholds kept for slot_recommender
# ============================================================================

# Tier classification thresholds (0-100 scale)
TIER_A_THRESHOLD = 85  # Excellent carriers
TIER_B_THRESHOLD = 70  # Good carriers
TIER_C_THRESHOLD = 50  # Acceptable carriers
...
def carrier_tier(score: float) -> str:
    ...
    Note: carrier_scoring.py has been removed
    """
