...
def _get_agent_classes() -> Dict[str, type]:
    ...
    try:
        from app.agents.operator_analytics_agent import OperatorAnalyticsAgent
        registry["OperatorAnalyticsAgent"] = OperatorAnalyticsAgent
    except ImportError as e:
        logger.warning(f"Could not import OperatorAnalyticsAgent: {e}")
